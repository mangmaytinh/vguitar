...
<div style="margin-left: 5px; margin-right: 15px;">
    ...
    <div style="clear: both;"><br /></div>
        <div style="margin-bottom: 16px; margin-top: 10px;">
    <a href="lyricmanager.aspx" title="Lyric Manager Page"><img src="../images/food-icon.png" style="float:left; border: 0;" /></a><div class="content12" style="padding-top: 20px; padding-left: 4px;">&nbsp;Lyric Manager - edit, delete, review and approve recipe.
    </div>
    <div style="clear: both;"><br /></div>
    ...
    <a href="articlemanager.aspx" title="Article Manager Page"><img src="../images/article-post-edit-icon.jpg" style="float:left; border: 0;" /></a><div class="content12" style="padding-top: 20px; padding-left: 4px;">&nbsp;Article Manager - edit, delete, add new category, review and approve article.
      ...
      <div style="clear: both;"><br /></div>
        <div style="margin-bottom: 16px; margin-top: 10px;">
    <a href="categorymanager.aspx" title="Lyric Category Manager Page"><img src="../images/categegory-folder-icon.jpg" style="float:left; border: 0;" /></a><div class="content12" style="padding-top: 20px; padding-left: 4px;">Lyric Category Manager - edit, delete and add new category.
    </div>
...
<div style="margin-left: 5px; margin-right: 15px;">
    <div style="margin-bottom: 16px; margin-top: 10px;">
    <a href="commentsmanager.aspx" title="Lyric Comments Manager Page"><img src="../images/comment-edit-icon.jpg" style="float:left; border: 0;" /></a><div class="content12" style="padding-top: 20px; padding-left: 7px;">&nbsp;&nbsp;Lyric Comments Manager - edit and delete recipe comments.
    </div>
       <div style="clear: both;"><br /></div>
        <div style="margin-bottom: 16px; margin-top: 10px;">
