<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="lyricmanager.aspx.cs" Inherits="admin_lyricmanager" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Admin Lyric Manager - XD World Lyric</title>
...
<div style="padding-left: 20px;"><h3><a name="Top"></a>Lyric Manager</h3></div>
</td>
  </tr>
  <tr>
...
<br />
<br />
<span class="bluearrow2">»</span>&nbsp;<asp:HyperLink runat="server" ID="lblmangermainpagelink" cssClass="dt" NavigateUrl="lyricmanager.aspx"><asp:Label id="lblmangermainpage" runat="server" /></asp:HyperLink>
<br />
<span class="bluearrow2">»</span>&nbsp;<a class="dt" href="lyricmanager.aspx?top=100" title="View the top 100 recipes by hits">View Top 100 Recipes</a>
<br />
<span class="bluearrow2">»</span>&nbsp;<a class="dt" href="lyricmanager.aspx?img=1" title="Display recipe with photo">View Lyric With Photo</a>
<br />
    ...
    <asp:HyperLink cssClass="dt" runat="server" ID="approvallink" NavigateUrl="lyricmanager.aspx?tab=1"><asp:Label ID="lblunapproved" runat="server" /></asp:HyperLink>
<br />
...
<!--Begin recipe name search panel-->
    <div class="nifty">
<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
<div class="dcntmenu"><span class="contadmin">Admin Lyric Name Search</span></div>
</div>
<div class="contentdisplayadmin">
<div class="contentdis5">
...
<!--Begin last viewed panel-->
 <div class="nifty">
<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
<div class="dcntmenu"><span class="contadmin">Lastviewed Lyric in Days, Week &amp; Month Report</span></div>
</div>
<div class="contentdisplayadmin">
<div class="contentdis5">
<div style="margin: 12px;">
...
<option value="lyricmanager.aspx?lv=1">Today</option>
<option value="lyricmanager.aspx?lv=2">2 days</option>
<option value="lyricmanager.aspx?lv=3">3 days</option>
<option value="lyricmanager.aspx?lv=4">4 days</option>
<option value="lyricmanager.aspx?lv=5">5 days</option>
<option value="lyricmanager.aspx?lv=6">6 days</option>
<option value="lyricmanager.aspx?lv=7">1 week</option>
<option value="lyricmanager.aspx?lv=14">2 weeks</option>
<option value="lyricmanager.aspx?lv=30">1 month</option>
</select>
</div>
</div>
</div>
...
<!--Begin month search panel-->
 <div class="nifty">
<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
<div class="dcntmenu"><span class="contadmin">Admin Lyric Month Search</span></div>
</div>
<div class="contentdisplayadmin">
<div class="contentdis5">
<div style="margin: 12px;">
...
<asp:DataGrid runat="server" id="dgrd_recipe" cssclass="hlink" AutoGenerateColumns="False" AllowSorting="true"
     ...
     <asp:BoundColumn DataField="Name" HeaderText="Lyric Name" SortExpression="Name" />
     <asp:BoundColumn DataField="LyricImage" HeaderText="Photo" SortExpression="LyricImage" />
...
<br />
  <asp:HyperLink id="Powered" cssClass="dt2" ToolTip="Visit our portal website" NavigateURL="http://www.ex-designz.net" runat="server">Powered By Ex-designz.net World Lyric .NET version</asp:HyperLink>
 </div>
<!--End Footer-->
<br />
</body>
