...
<title>Lyric Comment Manager</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="50%"><div style="padding-left: 6px;"><h3>Lyric Comments Manager</h3></div>
...
<table width="100%" border="0" cellspacing="1">
  <tr>
    <th scope="row"><div align="left">
     ...
     <asp:hyperlinkfield  HeaderText="Details" Text="View" datanavigateurlfields="ID" datanavigateurlformatstring="../lyricdetail.aspx?id={0}#DIS" target="_blank"/> 
     </Columns>
