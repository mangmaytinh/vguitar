...
<head runat="server">
    <title>Reviewing Lyric for Approval</title>
...
<br />
<div style="text-align: left;" class="content2"><asp:Button runat="server" Text="Approve This Lyric" id="approvebutton" cssClass="submitadmin" ToolTip="Click to approve this recipe" onclick="Approve_Recipe"/></div>
            			                 </td>
            		                  </tr>          		                  
            	                   </table>
<br />
