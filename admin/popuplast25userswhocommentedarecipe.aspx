...
<head id="Head1" runat="server">
    <title>Last 25 Users Who Commented a Lyric</title>
...
<body>
    ...
    <div>
        ...
        <span class="content2"><b>Last 25 Users Who Commented a Lyric</b></span>
     </div>
        <asp:Repeater id="UserRecipeComment" runat="server">     
        <ItemTemplate>
            <div class="dcnt2" style="margin-top: 2px;">
             <span class="content2"><a title="View complete profile" href="javascript:void(0)" onClick="window.open('../popupuserprofile.aspx?uid=<%# Eval("UID")%>','','width=880,height=700,scrollbars=yes,resizable=yes,status=no,left=180,top=180'); return false;" class="content2"><%# Eval("UserName")%></a> commented <a title="View this recipe" href="../lyricdetail.aspx?id=<%# Eval("ID")%>#DIS" target="_blank" class="content2"><%# Eval("Name")%></a> recipe on: <%# Eval("Date", "{0:M/d/yyyy}")%></span>
            </div>         
       </ItemTemplate>
    </asp:Repeater>
    </div>
