...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="50%"><div style="padding-left: 20px;"><h3>Lyric Manager &raquo; Editing Lyric</h3></div>
...
<div class="divmenu2">
<span class="bluearrow2">»</span>&nbsp;<asp:HyperLink runat="server" ID="lblmangermainpagelink" ToolTip="Back to recipe manager home" NavigateUrl="lyricmanager.aspx">Lyric Manager Home</asp:HyperLink>
<br />
</div>
      ...
      <table width="70%" border="0" cellpadding="3" cellspacing="1" align="left">
          <tr>
              <td colspan="2">
               <div class="nifty">
<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
<div style="text-align: left; padding-left: 6px;padding-bottom: 2px;"><span class="contadmin">Updating Lyric ID #: <%=Request.QueryString["id"]%></span></div>
</div>
    </td>
</tr>
      <tr>
