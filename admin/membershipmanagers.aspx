      ...
      <asp:Label id="lblalphaletter" runat="server" /></div><ul id="sddm">
       <li><a href="javascript:void(0)" onmouseover="mopen('m1')" onmouseout="mclosetime()">Other Options <img src="../images/arrow_down2.gif" border="0" /></a>
          <div id="m1" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
             ...
             <a class="thickbox" href="popuplast20userswhosumittedlyric.aspx?keepThis=true&TB_iframe=true&height=360&width=400" onmouseover="Tip('View the last 20 users who submitted a recipe.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()">Last 20 Users Who Submitted a Lyric</a>
             ...
             <a class="thickbox" href="popuplast25userswhoaddedrecipeinfavorite.aspx?keepThis=true&TB_iframe=true&height=360&width=400" onmouseover="Tip('View the last 25 users who added a friend in Friends List.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()">Last 25 Users Who Added a Lyric in CookBook</a>
             <a class="thickbox" href="popuplast25userswhocommentedarecipe.aspx?keepThis=true&TB_iframe=true&height=360&width=400" onmouseover="Tip('View the last 25 users who commented a recipe.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()">Last 25 Users Who Commented a Lyric</a>
          </div>
      </li>
    </ul>    
      </fieldset>
