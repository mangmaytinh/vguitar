...
namespace VGuitar.BL.Providers.Lyrics
{
    ...
    /// </summary>
    public sealed class LyricAlphaLetterProvider : Lyric
    {
        private static readonly LyricAlphaLetterProvider Instance = new LyricAlphaLetterProvider();
 
        static LyricAlphaLetterProvider() 
        {
        }

        LyricAlphaLetterProvider() 
        { 
        }

        public static LyricAlphaLetterProvider GetInstance()
        {
          return Instance;
        }

        public void LyricAlphaLetterParam(string letter, int OrderBy, int SortBy, int PageIndex, int PageSize)
        {
            this._Letter = letter;
        ...
        private IDataReader GetData
        {
            ...
            {
                //Get data
                IDataReader dr = Blogic.ActionProcedureDataProvider.GetLyricAlphaLetterWithPaging(Letter, OrderBy, SortBy, Index, PageSize);
                return dr;
            }
        }

        public ExtendedCollection<Lyric> GetLyricAlphabetLetter()
        {
