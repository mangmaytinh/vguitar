...
namespace VGuitar.BL
{
    ...
    public sealed class Blogic
    {
        ...
        /// </summary>
        public IDataReader GetAllLyricSubmittedByAuthor(string AuthorName, int OrderBy, int PageIndex, int PageSize)
        {
            SqlParameter prmAuthorName = new SqlParameter("@FindByAuthor", SqlDbType.NVarChar, 20);
            ...
            return DataAccess.GetFromReader("spSelectGetAllLyricByAuthor", prmAuthorName, prmOrderBy, prmPageIndex, prmPageSize);
        }
