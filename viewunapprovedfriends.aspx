<%@ Page Language="C#" MasterPageFile="~/SiteTemplate2.master" AutoEventWireup="true" CodeFile="viewunapprovedfriends.aspx.cs" Inherits="viewunapprovedfriends" Title="Phê duyệt yêu cầu kết bạn" %>
     ...
     <div style="margin-top: 5px; margin-bottom: 20px;">
        ...
        <asp:Panel ID="deleteConfirm" runat="server" style="display:none;">
            <div class="confirm">
                ...
                <div class="message">
                 <img src="images/icon_confirm.gif" alt="confirm icon" style="float: left; margin-right: 10px;" /> Bạn có chắc là bạn muốn từ chối <span style="color:#266B91"><b><%# Eval("Username")%></b></span>?
                </div>
                ...
                <div class="commands" style="text-align: center;">
                  ...
                  CausesValidation="false" CssClass="submitpopupmodal" ToolTip="Hủy từ chối" 
