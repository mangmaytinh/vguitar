<%@ Page Language="C#" AutoEventWireup="true" CodeFile="emaillyric.aspx.cs" Inherits="emaillyric" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Đang gửi bài hát <%=Request.QueryString["n"]%> tới bạn bè</title>
...
<tr><td>
<br />
<div align="center"><h2>Đang gửi bài hát <%=Request.QueryString["n"]%> tới bạn bè</h2></div>
<table border="0" cellspacing="1" cellpadding="1" width="100%">
  ...
  <tr>
    <td valign="top" align="right" class="content6"><b>Email của bạn:</b></td>
    <td>
...
<tr>
    <td valign="top" align="right" class="content6"><b>Gửi đến:</b></td>
    <td>
  ...
  <tr>
    <td valign="top" align="right" class="content6"><b>Gửi tới Email :</b></td>
    <td>
      ...
      <asp:RegularExpressionValidator runat="server"
        ...
        Display="Dynamic" /> 
        <br />
        <asp:Button runat="server" Text="Bắt đầu gửi" id="Sendrec" cssClass="submit" OnClick="SendingRecipe" /> 
    </td>
  </tr>
</table>
</td></tr>
