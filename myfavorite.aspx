...
<asp:HyperLink id="SortLinkDateAdded" cssClass="dsort" runat="server" />&nbsp;<asp:Image id="ArrowImage5" runat="server" />
     ...
     <div style="margin-top: 5px; margin-bottom: 16px;">
       ...
       <ItemTemplate>
        ...
        <asp:Label ID="lblDelete" runat="server" CssClass="thickbox" EnableViewState="false" />&nbsp;&nbsp;<a href="emaillyric.aspx?id=<%# Eval("itemID") %>&n=<%# Eval("LyricName") %>&c=<%# Eval("Category") %>&keepThis=true&TB_iframe=true&height=220&width=400" class="thickbox" title="Chia sẻ bài hát" onmouseover="Tip('Share <b><%# Eval("LyricName")%></b> cho bạn bè.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()"><img src="images/send_icon.gif" alt="Gửi Email" border="0" align="absmiddle" /></a>&nbsp;&nbsp;
