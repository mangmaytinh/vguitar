...
<div style="margin-left: 15px; width: 400px;">
    <div class="nifty">
<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
<div class="dcntmenu"><span class="contadmin">Enabled/Disabled Lyric Comment</span></div>
</div>
<div class="contentdisplayadmin">
<div class="contentdis5">
<div style="margin: 12px;">
<asp:dropdownlist id="ddlshowhide" runat="server" cssClass="cselect" AutoPostBack="false" EnableViewState="false">
<asp:Listitem Value="1">Enabled Lyric Comment</asp:Listitem>
<asp:Listitem Value="2">Disabled Lyric Comment</asp:Listitem>
</asp:dropdownlist>
...
<div style="margin-left: 15px; width: 400px;">
    <div class="nifty">
<b class="rtop"><b class="r1"></b><b class="r2"></b><b class="r3"></b><b class="r4"></b></b>
<div class="dcntmenu"><span class="contadmin">Number of Lyric Allowed to Save in CookBook</span></div>
</div>
<div class="contentdisplayadmin">
<div class="contentdis5">
<div style="margin: 12px;">
...
<asp:Listitem Value="20">20 Lyric per user</asp:Listitem>
<asp:Listitem Value="50">50 Lyric per user - default</asp:Listitem>
<asp:Listitem Value="100">100 Lyric per user</asp:Listitem>
<asp:Listitem Value="150">150 Lyric per user</asp:Listitem>
<asp:Listitem Value="200">200 Lyric per user</asp:Listitem>
<asp:Listitem Value="250">250 Lyric per user</asp:Listitem>
</asp:dropdownlist>
