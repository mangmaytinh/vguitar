     ...
     <asp:Panel ID="HideContentIfNotLogin" runat="server">
        ...
        <ItemTemplate>
            <div class="dcnt2" style="margin-top: 2px;">
             <span class="content2"><a title="View this recipe" href="lyricdetail.aspx?id=<%# Eval("RecipeID")%>" class="content2" target="_blank"><%# Eval("LyricName")%></a> added in Cook Book on: <%# Eval("Date", "{0:M/d/yyyy}")%></span>
            </div>         
       </ItemTemplate>
    </asp:Repeater>
    </asp:Panel>
