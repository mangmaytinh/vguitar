...
namespace VGuitar.BL
{
    ...
    public sealed class ProviderSiteStatistics : SiteStatistics
    {
        ...
        public override void fillup()
        {
            ...
            while (dr.Read())
            {
                if (dr["TotalLyric"] != DBNull.Value)
                {
                    this._TotalLyric = (int)dr["TotalLyric"];
                }
                ...
                if (dr["TotalLyricComments"] != DBNull.Value)
                {
                    this._TotalLyricComments = (int)dr["TotalLyricComments"];
                }
