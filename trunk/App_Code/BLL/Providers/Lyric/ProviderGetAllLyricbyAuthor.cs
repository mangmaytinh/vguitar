...
namespace VGuitar.BL.Providers.Lyrics
{
    ...
    /// </summary>
    public sealed class ProviderGetAllLyricbyAuthor : Lyric
    {
        private static readonly ProviderGetAllLyricbyAuthor Instance = new ProviderGetAllLyricbyAuthor();

        static ProviderGetAllLyricbyAuthor()
        {
        }

        ProviderGetAllLyricbyAuthor()
        {
        }

        public static ProviderGetAllLyricbyAuthor GetInstance()
        {
            return Instance;
        }
