...
namespace VGuitar.BL
{
    ...
    public sealed class Addrating : Rating
    {
        ...
        public void Insert()
        {
            ...
            switch (WhatPageID)
            {
                case constant.intLyric: //Insert recipe rating and redirect back to lyricdetail.aspx
                    Blogic.AddRating(ID, RateVal);
                    HttpContext.Current.Response.Redirect("lyricdetail.aspx?id=" + ID);
                    break;
