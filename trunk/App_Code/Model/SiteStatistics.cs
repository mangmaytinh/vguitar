...
namespace VGuitar.Model
{
    ...
    public class SiteStatistics : DBObj
    {
        ...
        protected int _TotalLyric;
        protected int _TotalArticle;
        protected int _TotalMembers;
        protected int _TotalLyricComments;
        ...
        public int TotalLyric
        {
            get { return _TotalLyric; }
            set { _TotalLyric = value; }
        }
        ...
        {
            get { return _TotalLyricComments; }
            set { _TotalLyricComments = value; }
        }
