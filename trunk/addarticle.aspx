...
<fieldset><legend>Nội dung của bài viết</legend>
...
<span class="cred2">Yêu cầu điền đầy đủ các nội dung vào đây</span> 
</div>
<div style="margin-top: 8px;">
<table border="0" cellpadding="2" cellspacing="2" width="76%">
  <tr>
    <td width="26%"><span class="content12">Chuyên mục:</span></td>
    <td width="74%">
<asp:dropdownlist id="ddlarticlecategory" runat="server" cssClass="ddl" AutoPostBack="false"></asp:dropdownlist>
          ...
          cssClass="cred2"
          InitialValue="0"
          ErrorMessage = "Phải chọn một phân phân loại"
          display="Dynamic"> </asp:RequiredFieldValidator>
</td>
  </tr>
    <tr>
    <td width="26%"><span class="content12">Tác giả bài viết:</span></td>
    <td width="74%">
<span class="cmaron"><asp:Label ID="lblauthorname" cssClass="cmaron" runat="server" /></span>
</td>
  </tr>  
  <tr>
    <td width="26%"><span class="content12">Tiêu đề bài viết:</span><span class="cred2">*</span></td>
    <td width="74%">
<input type="text" id="Title" name="Title" class="textbox" size="60" runat="server" onFocus="this.style.backgroundColor='#FFFBE1'" onBlur="this.style.backgroundColor='#ffffff'" onmouseover="Tip('65 characters maximum for the <b>Title</b>', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
      <asp:RequiredFieldValidator runat="server"
        ...
        cssClass="cred2" errormessage="* Yêu cầu phải có tiêu đề bài viết:<br />"
        display="Dynamic" />
</td>
  </tr>
        <tr>
    <td width="26%" valign="top"><span class="content12">Nội dung tóm tắt:</span><span class="cred2">*</span></td>
    <td width="74%">
<textarea runat="server" id="Summary" class="mceNoEditor textbox" cols="80" rows="3" onmouseover="Tip('350 characters maximum for the <b>Summary</b>, and should not contain HTML tag.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
      <asp:RequiredFieldValidator runat="server"
        ...
        cssClass="cred2" errormessage="* Phải đưa nội dung tóm tắt vào:<br />"
        display="Dynamic" />
</td>
  </tr>
    <tr>
    <td width="26%" valign="top"><span class="content12">Nội dung bài viết:</span><span class="cred2">*</span></td>
    <td width="74%">
<textarea runat="server" id="Content" name="Content" class="textbox" cols="80" style="width: 80%" rows="50" onFocus="this.style.backgroundColor='#FFFBE1'" onBlur="this.style.backgroundColor='#ffffff'" />
    ...
    <tr>
    <td width="26%"><span class="content12">Từ khóa:</span><span class="cred2">*</span></td>
    <td width="74%">
<input type="text" id="Keyword" name="Keyword" class="textbox" size="65" runat="server" onFocus="this.style.backgroundColor='#FFFBE1'" onBlur="this.style.backgroundColor='#ffffff'" onmouseover="Tip('60 characters maximum for the <b>Summary</b>, and should not contain HTML tag.<br>Multiple keywords must be separated with comma.', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
      <asp:RequiredFieldValidator runat="server"
        ...
        cssClass="cred2" errormessage="* Yêu cầu nhập từ khóa cho bài viết:<br />"
        display="Dynamic" />
</td>
  </tr>
  <tr>
...
<br />
<asp:Button runat="server" Text="Submit" id="AddArticle" cssClass="submitadmin" OnClick="Add_Article" onmouseover="Tip('', BGCOLOR, '#FFFBE1', BORDERCOLOR, '#acc6db')" onmouseout="UnTip()" />
</td>
  </tr>
</table>
 </div>
...
<div id="footer">
        ...
        <br />
        <span class="content2">
        Copyright © 2000 - 2009 thlb.biz. Được phát triển bởi <a class="dt2" title="Website" href="http://thlb.biz">Vlib - thlb.biz</a></span>
        <br />
         <asp:HyperLink id="Powered" cssClass="dt2" ToolTip="Ghé thăm website" NavigateURL="http://thlb.biz" runat="server">Phát triển bởi Vina.knighs trên nền .NET 2.0</asp:HyperLink>
         <br /><br />
         </div>
        <!--End Footer-->  
  </div>
