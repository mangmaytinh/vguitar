...
public partial class test : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Response.Write("IsUserBlockedFomSendingPM = " + Blogic.IsUserBlockedByLyric(ToUserName, SenderUID) + "<br>");
        //Response.Write("<br><br>");
        ...
        Message.LyricUserName = "Webmaster";
        ...
        */
        ...
        HttpCookie GetUserInfo = HttpContext.Current.Request.Cookies["VGWRUserInfo"];
        ...
        SendeMail.LyricEmail = "karlos25@yahoo.com";
