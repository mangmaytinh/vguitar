...
<body>
    ...
    <span class="cyel">&raquo;</span>&nbsp;<a href="findalllyricbyauthor.aspx?author=<%=Request.QueryString["author"]%>" title="Browse all recipe by <%=Request.QueryString["author"]%>." class="content2">Browse All Lyric by <%=Request.QueryString["author"]%></a>
    </div>
    <div style="margin: 2px;">
